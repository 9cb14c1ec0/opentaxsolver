Open Tax Solver - California State Tax Return 540 for 2021
----------------------------------------------------------

Included here is a program, template, and example for
California State tax form CA-540 for tax-year 2021.
...
such as "CA_540_2021.txt" or "CA_540_2021_aunt_sally.txt, and 
fill-in the lines.

The program consist of two files:
  taxsolve_CA_540_2021.c - main, customized for CA 540.
  taxsolve_routines.c - general purpose base routines.

Compile:   
  cc taxsolve_CA_540_2021.c -o taxsolve_CA_540_2021

Run:
  ./taxsolve_CA_540_2021  CA_540_2021.txt
