...
int main( int argc, char *argv[] )
{
 ...
 double sched540A[MAX_LINES], sched540B[MAX_LINES], sched540C[MAX_LINES],
 ...
 */
 ...
 switch (status)
  {
   case SINGLE:
   case MARRIED_FILLING_SEPARAT:  threshA = 203341.0;	std_ded = 4601.0;  break;	/* Not updated for 2021. */
