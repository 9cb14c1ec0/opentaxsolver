...
The PA40_2017_example.txt file is included for testing.
The PA40_2017_template.txt file is a blank starting form for entering
your tax data.  For each filer, copy template to a new name, 
such as "PA40_2017.txt" or "PA40_2017_aunt_sally.txt, and 
fill-in the lines.

The program consists of two files:
  taxsolve_PA40_2017.c - main, customized for PA-40.
  taxsolve_routines.c - general purpose base routines.

Compile:
  cc taxsolve_PA40_2017.c -o taxsolve_PA40_2017

Run:
  ./taxsolve_PA40_2017  PA40_2017.txt
