Open Tax Solver - California State Tax Return 540 for 2017
----------------------------------------------------------

Included here is a program, template, and example for
California State tax form CA-540 for tax-year 2017.
...
such as "CA_540_2017.txt" or "CA_540_2017_aunt_sally.txt, and 
fill-in the lines.

The program consist of two files:
  taxsolve_CA_540_2017.c - main, customized for CA 540.
  taxsolve_routines.c - general purpose base routines.

Compile:   
  cc taxsolve_CA_540_2017.c -o taxsolve_CA_540_2017

Run:
  ./taxsolve_CA_540_2017  CA_540_2017.txt
