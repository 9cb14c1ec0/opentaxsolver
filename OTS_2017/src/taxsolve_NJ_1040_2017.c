/************************************************************************/
/* TaxSolve_NJ_1040_2017.c - 						*/
/* Copyright (C) 2017 - Aston Roberts					*/
/* 									*/
/* Compile:   gcc taxsolve_NJ_1040_2017.c -o taxsolve_NJ_1040_2017	*/
/* Run:	      ./taxsolve_NJ_1040_2017  NJ_1040_2017.txt 		*/
/* 									*/
...
/* 02111-1307 USA							*/
/* 									*/
/* Aston Roberts 1-25-2017	aston_roberts@yahoo.com			*/
/*    2-14-05   BWB							*/
...
*/
 ...
 GetLineF( "L19a", &L[19] );	/* Pensions, Annuities, and IRA Withdrawals (pg 20). */
 ...
 fprintf(outfile,"\n");  /* Property Tax Deduction Worksheet G (pg 34). */
 F[1] = L37a;
 ...
 // L[40] = TaxRateFunction( L[39], status );  /* Handled above in Schedules+Worksheets, A, G, H. */
 showline_wmsg(40, "TAX");
 Report_bracket_info( L[39], status );
