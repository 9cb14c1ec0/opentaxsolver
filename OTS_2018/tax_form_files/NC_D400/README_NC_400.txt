...
The NC400_2018_example.txt files is included for testing.
The NC400_2018_template.txt file is a blank starting form for
entering your tax data.  For each filer, copy template to a new
name, such as "NC400_2018.txt" or "NC400_2018_aunt_sally.txt,
and fill-in the lines.

The program consists of two files:
  taxsolve_NC400_2018.c - main, customized for NC D-400.
  taxsolve_routines.c - general purpose base routines.

Compile:
  cc taxsolve_NC400_2018.c -o taxsolve_NC400_2018

Run:
 First, run your Federal 1040 taxes and note the output file.
  ./taxsolve_fed1040_2018 fed1040_2018.txt 
 Then, complete your NC400 form input data file and run.
  ./taxsolve_NC400_2018  NC400_2018.txt
...
Updated by ARoberts for 2008-2018 (aston_roberts@yahoo.com)
